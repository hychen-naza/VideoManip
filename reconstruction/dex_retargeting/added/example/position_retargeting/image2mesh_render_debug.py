...
if __name__ == "__main__":
    ...
    objects = ['scissors', 'lantern'] #['power_drill', 'pen', 'wine_glass', 'spray', 'tong', 'syringe'] #['power_drill', 'pen', 'wine_glass', 'spray', 'tong', 'syringe']
    obj_idx = [0, 84]#[98, 190, 22, 39, 7, 49] #[17, 5, 22, 8, 7, 49]
